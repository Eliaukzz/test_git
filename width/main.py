...
while True:
    try:
        ...
        cursor = conn.cursor()
        query = 'SELECT TOP 1 ID, Path, Note, SlabMWidth1 from tblSlabDefectInformationHistory where SlabMWidth1 = 0   order by ProductionTime desc'

        # query = 'SELECT TOP 1 ID,Path,Note ,SlabMWidth1 from tblSlabDefectInformationHistory where SlabMWidth1 = 0  order by ProductionTime desc'
        # query = 'SELECT TOP 10 ID,Path,Note ,SlabMWidth1 from tblSlabDefectInformationHistory  order by ProductionTime desc'
